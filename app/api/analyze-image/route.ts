  ...
  try {
    ...
    const fastPrompts = {
      ...
      style: selectedStylePreset
        ? `First, identify the ACTUAL artistic style of this image (e.g., Studio Ghibli anime, Pixar 3D, photorealistic, oil painting, comic book, graphic novel ink noir, etc.). Then in 1-2 sentences, state what style this image is and explain if it matches or differs from the requested "${selectedStylePreset}" style.`
        : "In 1-2 sentences, identify the specific artistic style (e.g., Pixar 3D animation, Studio Ghibli anime, Disney animation, oil painting, watercolor, manga, comic book, graphic novel ink noir, Art Deco, impressionism, cyberpunk art, minimalist design, etc.) and describe its key visual characteristics.",
