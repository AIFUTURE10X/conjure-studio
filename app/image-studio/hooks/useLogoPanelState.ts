...
export function useLogoPanelState({
  ...
  const [selectedModel, setSelectedModel] = useState<LogoGenerationModel>(DEFAULT_LOGO_GENERATION_SETTINGS.model)
  ...
  const handleClearAll = useCallback(() => {
    ...
    setAspectRatio('1:1')
    setResolution('1K')
    setSelectedModel(DEFAULT_LOGO_GENERATION_SETTINGS.model)
    setTextMode('ai-text')
