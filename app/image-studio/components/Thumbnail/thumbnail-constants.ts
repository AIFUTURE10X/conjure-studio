...
export const THUMBNAIL_AI_STYLES: ThumbnailAiStyle[] = [
  ...
  { id: 'clay', label: 'Claymation', prompt: 'stop-motion claymation film still, handmade plasticine characters with visible fingerprints, miniature handcrafted set, macro photo, soft diffused lighting' },
  { id: 'digital-clay', label: '3D Digital Clay', prompt: 'polished 3D digital clay animation, computer-rendered clay characters, smooth clean surfaces, precise symmetrical features, soft subsurface shading, cinematic global illumination' },
