...
export function ImageSettingsRail() {
  ...
  const resetCameraStyle = () => {
    state.setSelectedCameraAngle('')
    state.setSelectedCameraLens('')
    state.setStyleStrength('moderate')
    state.setCreativeDirection(DEFAULT_CREATIVE_DIRECTION)
  }
  const resetAdvanced = () => {
    state.setSeed(null)
  ...
  return (
    <div className="p-4 space-y-5">
      <div className="flex items-center justify-between">
        <span className="text-xs font-semibold text-zinc-300">Image settings</span>
        <button
          type="button"
          onClick={resetAllSettings}
          title="Reset all image settings to defaults"
      ...
      <RailSection title="Camera & Style" onReset={resetCameraStyle}>
