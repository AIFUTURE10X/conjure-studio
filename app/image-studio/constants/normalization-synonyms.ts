...
export const styleSynonyms: Record<string, string> = {
  ...
  'laika stop motion': 'Laika',
  'claymation': 'Clay 3D',
  'clay animation': 'Clay 3D',
  'clay render': 'Clay 3D',
  'clay sculpture': 'Clay 3D',
  'plasticine': 'Clay 3D',
  'play-doh': 'Clay 3D',
  'stop motion clay': 'Clay 3D',
  'stop-motion clay': 'Clay 3D',
  '3d digital clay': '3D Digital Clay',
  'digital clay': '3D Digital Clay',
  'digital clay 3d': '3D Digital Clay',
  'smooth clay render': '3D Digital Clay',
  ...
  'noir comic': 'Ink Noir',
  'comic noir': 'Ink Noir',
  'comic book noir': 'Ink Noir',
  'noir comic book': 'Ink Noir',
  'graphic novel': 'Ink Noir',
  'graphic novel style': 'Ink Noir',
  'graphic novel noir': 'Ink Noir',
  'chiaroscuro': 'Ink Noir',
  'chiaroscuro noir': 'Ink Noir',
  'sin city style': 'Ink Noir',
  'high contrast ink': 'Ink Noir',
